...
async function getRemoteUrl() {
    return new Promise((resolve, reject) => {
        exec('git config --get remote.origin.url', (error, stdout, stderr) => {
            ...
            // format is either:
            // git@github.com:UUDigitalHumanitieslab/jewish-historical-migration.git
            // or https://github.com/UUDigitalHumanitieslab/jewish-historical-migration.git
            // or https://USERNAME:SECRET@github.com/UUDigitalHumanitieslab/jewish-historical-migration.git/
